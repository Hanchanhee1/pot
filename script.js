...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        ko: {
            ...
            'career.item.aiCourse.desc': '<strong>학습 :</strong> Java, Python, JavaScript, MySQL, JSP/Servlet, Spring Boot, React, ML/DL, 시각지능 모델링, AI, MLOps, 네이버 클라우드<br><strong>프로젝트 :</strong> 뽀삐데이트 (팀장) / AIMAE (팀장) / 청취 (팀장) 3건 완료',
        ...
        ja: {
            ...
            'career.item.aiCourse.desc': '<strong>学習：</strong> Java, Python, JavaScript, MySQL, JSP/Servlet, Spring Boot, React, ML/DL、視覚知能モデリング、AI, MLOps、NAVERクラウド<br><strong>プロジェクト：</strong> ポピーデート（リーダー）/ AIMAE（リーダー）/ 청취（リーダー） 計3件',
